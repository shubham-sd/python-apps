...
f_player = str(input("How is your point gaurd: ")).title().strip()
s_player = str(input("How is your shooting gaurd: ")).title().strip()
...
print(f"\t\t Point Gaurd: \t\t{f_player}")
print(f"\t\t Shooting Gaurd: \t{s_player}")
